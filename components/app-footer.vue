...
<template>
    ...
    <div class="max-w-[1280px] mx-auto px-4">
      ...
      >
        ...
        <div class="lg:col-span-2">
          ...
          >
            <div class="p-1.5 rounded bg-[#07B300] text-black">
              <svg
          ...
          <p class="text-gray-400 leading-relaxed mb-8 max-w-sm">
            The modern platform for creating, discovering, and managing
      ...
      >
        <div class="text-gray-500 text-sm">
          &copy; 2025 EventNest. All rights reserved.
        </div>
  ...
  <button
    class="fixed bottom-8 right-8 w-14 h-14 bg-[#07B300] hover:bg-[#16a34a] rounded-full shadow-lg shadow-[#22c55e]/30 flex items-center justify-center text-black transition-transform hover:scale-110 z-50"
  >
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="28"
